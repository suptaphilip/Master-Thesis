...
\begin{itemize}
 ...
 \item How could find appropriate menu(calorie, price).
...
\begin{itemize}
 ...
 \item  provide dieting services to users.
...
\centering
  \includegraphics[height=7.7cm,width=12.2cm]{images/index.jpg}
\end{frame}
...
\centering
  \includegraphics[height=7.7cm,width=12.2cm]{images/dashboard.jpg}
...
\centering
  \includegraphics[height=7.7cm,width=12.2cm]{images/foodmenusuggestion.jpg}
...
\begin{frame}\frametitle{Evaluation Methodology}
 \begin{itemize}
   ...
   \item Given them 14 usability questions [likert scale: 1-7] to evaluate.
 \begin{itemize}
    \item usefulness
    \item easy to use
    \item learnability
    \item Satisfaction
\end{itemize}
	\item Evaluation for both Desktop and Mobile Prototype.
	\item Result calculate using Mean($\mu$) and Standard deviation($\sigma$)\\
...
\begin{frame}\frametitle{Evaluation Result for Desktop Prototye}
\centering
  \includegraphics[height=6.5cm,width=10.5cm]{images/UsabilityEvaluationGraphDesktop.jpg}

\end{frame}
\begin{frame}\frametitle{Evaluation Result for Mobile Prototye}
\centering
\includegraphics[height=6.5cm,width=10.5cm]{images/UsabilityEvaluationGraphMobile.jpg}
\end{frame}
...
``Smart Cafeteria''
 \begin{itemize}
    \item could solve the problems mostly [reduce queue time through notification].
    \item is adaptive [its functionalities].
    \item is interactive [Usability Evaluation].
\end{itemize}
Future Work
 \begin{itemize}
    \item Build high fidelity prototype [full functional]. 
    \item Find out best machine learning approach for adaptability.
